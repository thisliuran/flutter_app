...
import 'package:flutter_app/bottombar/navigationIconView.dart';
...
class _IndexState extends State<Index> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _navigationViews = <NavigationIconView>[
      ...
      //new NavigationIconView(icon: new Icon(Icons.search), title: new Text("查询"), vsync: this),
      new NavigationIconView(icon: new Icon(Icons.file_download), title: new Text("入库"), vsync: this),
      new NavigationIconView(icon: new Icon(Icons.publish), title: new Text("领用"), vsync: this),
      //new NavigationIconView(icon: new Icon(Icons.add), title: new Text("增加"), vsync: this),
      new NavigationIconView(icon: new Icon(Icons.history), title: new Text("历史"), vsync: this),
    ];
  ...
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      home: new Scaffold(
        appBar: AppBar(title:_navigationViews[_currentIndex].item.title ,),
        body: new Center(
